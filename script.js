const menuButton = document.getElementById('menuButton');
    ...
    const navTranslations = {
      en: { about: 'About Us', story: 'Our Story', brands: 'Our Brands', franchise: 'Franchise', contact: 'Contact Us' },
      th: { about: 'เกี่ยวกับเรา', story: 'จุดเริ่มต้น', brands: 'แบรนด์ในเครือ', franchise: 'แฟรนไชส์', contact: 'ติดต่อเรา' }
    };
    let navLanguage = 'en';
